        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StatusAtReportTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PdfFileName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PdfContentType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskReports_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskReports_TaskItems_TaskItemId",
                        column: x => x.TaskItemId,
                        principalTable: "TaskItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "09f74a45-9f8f-4332-b5c5-32f95d875daf", null, "Manager", "MANAGER" },
                    { "241d532d-c7a5-4285-9049-fc3c48c246b6", null, "CompanyOwner", "COMPANYOWNER" },
                    { "9480852c-dfbe-4d18-8dc3-5ac2caa98449", null, "Admin", "ADMIN" },
                    { "fcb74908-0ce1-4605-b7d2-5cec6dbfba5a", null, "Worker", "WORKER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskReports_CreatedById",
                table: "TaskReports",
                column: "CreatedById");
